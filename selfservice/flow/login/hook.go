...
func (e *HookExecutor) PostLoginHook(
	...
	if x.IsJSONRequest(r) {
		...
		if a.OAuth2LoginChallenge != "" {
			postChallengeURL, err := e.d.Hydra().AcceptLoginRequest(r.Context(), string(a.OAuth2LoginChallenge), i.ID.String(), s.ID.String(), s.AMR)
			if err != nil {
				return err
			}
	...
	if a.OAuth2LoginChallenge != "" {
		rt, err := e.d.Hydra().AcceptLoginRequest(r.Context(), string(a.OAuth2LoginChallenge), i.ID.String(), s.ID.String(), s.AMR)
		if err != nil {
			return err
		}
		finalReturnTo = rt
